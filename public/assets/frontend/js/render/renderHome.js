  ...
  const html = `
    <div class="banner-slide" style="${bgImage ? `background-image: url('${bgImage}');` : ''}">
      <div class="hero__inner">
        ...
        <a href="${baseUrl}/products" class="btn btn-primary">${firstBanner.button_text || firstBanner.cta || 'Lihat Produk'}</a>
      </div>
    </div>
  ...
  if (slideContent) {
    ...
    slideContent.innerHTML = `
      <div class="hero__inner">
        ...
        <a href="${baseUrl}/products" class="btn btn-primary">${banner.button_text || banner.cta || 'Lihat Produk'}</a>
      </div>
    `;
  }
