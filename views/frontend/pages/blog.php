...
<style>
    ...
    .blog-hero-small {
        display: flex;
        flex-direction: column;
        /* Stack vertikal (Gambar atas, Teks bawah) */
    ...
    @media (max-width: 768px) {
        ...
        /* Maintain Grid Layout but scale down */
        .blog-hero {
            /* Keep grid 1.5fr 1fr but slightly adjust gap */
            grid-template-columns: 1.5fr 1fr;
            gap: 12px;
        }
