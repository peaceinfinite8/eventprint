...
<div class="d-flex align-items-center justify-content-between mb-4 fade-in">
  <div>
    <h1 class="h4 mb-1 fw-bold text-gradient">Edit Bahan</h1>
    <p class="text-muted small mb-0">Perbarui informasi bahan material</p>
  </div>
</div>
  ...
  <div class="p-4">
    <form method="post" action="<?php echo $baseUrl; ?>/admin/materials/update/<?php echo $material['id']; ?>"
        ...
        <div class="col-md-7">
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text" name="name" class="form-control" required
                value="<?php echo htmlspecialchars($old['name'] ?? $material['name'], ENT_QUOTES, 'UTF-8'); ?>">
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control bg-light" disabled
              value="<?php echo htmlspecialchars($material['slug'], ENT_QUOTES, 'UTF-8'); ?>">
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <input type="number" name="price_delta" class="form-control" step="500" min="0"
                value="<?php echo htmlspecialchars($old['price_delta'] ?? $material['price_delta'], ENT_QUOTES, 'UTF-8'); ?>">
            </div>
          ...
          <div class="p-4 bg-light rounded border border-light h-100">
            ...
            <div class="mb-3">
              ...
              <input type="number" name="sort_order" class="form-control"
                value="<?php echo htmlspecialchars($old['sort_order'] ?? $material['sort_order'], ENT_QUOTES, 'UTF-8'); ?>">
            </div>
            ...
            } elseif (isset($material['is_active'])) {
              $isActiveChecked = ((string) $material['is_active'] === '1') ? 'checked' : '';
            }
            ?>
      ...
      <div class="d-flex justify-content-end gap-2 mt-5 pt-3 border-top">
        <a href="<?php echo $baseUrl; ?>/admin/materials" class="btn btn-outline-secondary px-4">Kembali</a>
