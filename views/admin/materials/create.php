...
<div class="dash-container-card fade-in delay-1">
  <div class="p-4">
    <form method="post" action="<?php echo $baseUrl; ?>/admin/materials/store" enctype="multipart/form-data">
          ...
          <div class="col-md-5">
              <div class="p-4 bg-light rounded border border-light h-100">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="form-text small">Opsional. Muncul saat bahan dipilih.</div>
                  </div>
