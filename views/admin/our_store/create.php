...
<div class="dash-container-card fade-in delay-1">
    <div class="p-4">
        <form method="post" action="<?php echo $baseUrl; ?>/admin/our-home/stores/store" enctype="multipart/form-data">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" required placeholder="Contoh: Kantor Pusat"
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="slug" class="form-control" placeholder="auto-generate-jika-kosong"
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="city" class="form-control" required
                                placeholder="Contoh: Jakarta Pusat" value="<?php echo $val('city'); ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="dash-form-label">GOOGLE MAPS URL</label>
                            <input type="text" name="gmaps_url" class="form-control"
                                placeholder="https://maps.google.com/..." value="<?php echo $val('gmaps_url'); ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text small">
                            Masukkan format Array JSON. Contoh:
                            <code>["Senin-Jumat: 09.00-17.00", "Sabtu: 09.00-14.00"]</code>
                        </div>
                    </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active"
                                        value="1" <?php echo $checked('is_active', true); ?>>
