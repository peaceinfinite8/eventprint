  ...
  <div class="p-4">
    <form action="<?php echo $baseUrl; ?>/admin/our-home/stores/update/<?php echo (int)$item['id']; ?>"
        ...
        <div class="col-lg-8">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    ...
                    <div class="form-text small">Slug sekarang: <code class="text-dark bg-light px-1 rounded"><?php echo htmlspecialchars($item['slug'] ?? '', ENT_QUOTES, 'UTF-8'); ?></code></div>
                </div>
                <div class="col-md-6">
        ...
        <div class="col-lg-4">
             ...
             <div class="card border border-light bg-light mt-3">
                 <div class="card-body">
                    ...
                    <div class="form-text small mt-2">Kosongkan jika tidak ingin mengganti foto.</div>
                 </div>
             </div>
        </div>
      ...
      <div class="d-flex gap-2 mt-5 pt-3 border-top">
        ...
        <a href="<?php echo $baseUrl; ?>/admin/our-home/stores" class="btn btn-outline-secondary px-4"><i class="fas fa-arrow-left me-2"></i>Kembali</a>
      </div>
