  ...
  <div class="p-4">
    <form method="post" action="<?php echo $baseUrl; ?>/admin/testimonials/store" enctype="multipart/form-data">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="position" class="form-control"
                        placeholder="Contoh: CEO, Customer"
        ...
        <div class="col-lg-4">
             <div class="card border border-light bg-light mt-0">
                 <div class="card-body">
                    ...
                    <div class="mb-3 text-center p-4 border-2 border-dashed rounded bg-white">
                        <i class="fas fa-user-circle fa-3x text-muted mb-2"></i>
                        <input type="file" name="photo" class="form-control text-sm" accept="image/*">
                        <small class="text-muted d-block mt-2">Format: JPG, PNG, WEBP. <br>Maksimal 2MB.</small>
                    </div>

                    <div class="form-check form-switch mt-3">
                        <input type="checkbox" name="is_active" class="form-check-input" id="is_active" value="1"
                            <?php echo !empty($old['is_active']) || !isset($old['is_active']) ? 'checked' : ''; ?>>
      ...
      <div class="d-flex gap-2 mt-5 pt-3 border-top">
        ...
        <a href="<?php echo $baseUrl; ?>/admin/testimonials" class="btn btn-outline-secondary px-4"><i class="fas fa-arrow-left me-2"></i>Batal</a>
      </div>
    </form>
  </div>
</div>
