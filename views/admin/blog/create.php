                ...
                <div class="col-lg-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="excerpt" rows="3" class="form-control"
                            placeholder="Ringkasan singkat untuk tampilan list..."><?php echo htmlspecialchars($old['excerpt'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="content" rows="12" class="form-control" required
                            placeholder="Tulis konten lengkap artikel di sini..."><?php echo htmlspecialchars($old['content'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-8">
                            ...
                            <small class="text-muted d-block mt-1">Jika diisi, klik pada artikel akan redirect ke URL
                                ini.</small>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="link_target" class="form-select">
                                ...
                                <option value="_self" <?php echo $target === '_self' ? 'selected' : ''; ?>>Tab Sama
                                    (_self)</option>
                                <option value="_blank" <?php echo $target === '_blank' ? 'selected' : ''; ?>>Tab Baru
                                    (_blank)</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="post_category" class="form-select">
                                    ...
                                    <option value="tren" <?php echo $selected_cat === 'tren' ? 'selected' : ''; ?>>Tren
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="post_type" class="form-select">
                                    ...
                                    <option value="normal" <?php echo $selected_type === 'normal' ? 'selected' : ''; ?>>
                                        Normal (Default)</option>
                                    <option value="large" <?php echo $selected_type === 'large' ? 'selected' : ''; ?>>
                                        Large (Grid Besar)</option>
                                    <option value="small" <?php echo $selected_type === 'small' ? 'selected' : ''; ?>>
                            ...
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label fw-bold text-success" for="publishedCheck">Publish
                                    Sekarang</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="text-center p-3 border-2 border-dashed rounded bg-white mb-2">
                                    ...
                                    <input type="file" name="thumbnail" class="form-control text-sm"
                                        accept="image/jpeg,image/png,image/webp" data-cropper="true"
                                        data-aspect-ratio="1.3333">
                                </div>
                                <small class="text-muted">Format: JPG, PNG, WEBP. Rasio 4:3 (Hero).</small>
