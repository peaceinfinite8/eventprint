<?php
/* ============================================================================
   public/routes/admin.php — Admin Routes
   ========================================================================== */
...
$router->get('/admin', 'UserController@adminRoot');

/* DASHBOARD */
$router->get('/admin/dashboard', 'DashboardController@index', ['AuthRequired']);

/* PRODUCTS */
$router->get('/admin/products/{id}/options', 'ProductOptionController@index', ['AuthRequired']);
...
$router->post('/admin/products/gallery/upload/{id}', 'ProductController@uploadGallery', ['AuthRequired', 'SuperAdminOnly']);
$router->get('/admin/products/gallery/delete/{id}', 'ProductController@deleteGalleryImage', ['AuthRequired', 'SuperAdminOnly']);
