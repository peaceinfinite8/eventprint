...
// ======================= OUR STORE =======================
$router->get('/admin/our-store',             'OurStoreController@index',  ['AuthRequired', 'SuperAdminOnly']);
$router->get('/admin/our-store/create',      'OurStoreController@create', ['AuthRequired', 'SuperAdminOnly']);
$router->post('/admin/our-store/store',      'OurStoreController@store',  ['AuthRequired', 'SuperAdminOnly']);
$router->get('/admin/our-store/edit/{id}',   'OurStoreController@edit',   ['AuthRequired', 'SuperAdminOnly']);
$router->post('/admin/our-store/update/{id}','OurStoreController@update', ['AuthRequired', 'SuperAdminOnly']);
$router->post('/admin/our-store/delete/{id}','OurStoreController@delete', ['AuthRequired', 'SuperAdminOnly']);
