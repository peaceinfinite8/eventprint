...
function renderContactDetails(settings) {
  ...
  let html = `
    ...
    <div class="contact-detail mb-2">
      <div class="contact-icon"><i class="fab fa-whatsapp" style="font-size: 1.2rem; color: #25D366;"></i></div>
...
function updateCharCounter() {
  ...
  if (textarea && counter) {
    ...
    if (current >= max) {
      ...
      counter.style.color = '#f59e0b'; // Orange when 90%
    } else {
      counter.style.color = '#6b7280'; // Gray by default
    }
  }
}
